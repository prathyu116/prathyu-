...
const PortfolioCard = ({
  ...
  return (
    <div
      className={` p-4 rounded-2xl bg-zinc-800 hover:bg-zinc-700/50 active:bg-zinc-700/60 ring-1 ring-inset ring-zinc-50/5 transition-colors ${classes}`}
    >
      <figure className="relative img-box aspect-square rounded-lg ">
      ...
      <div className="flex items-center justify-between gap-4">
        ...
        <a href={gitHubLink} target="_blank" rel="noopener noreferrer">
          <div className=" w-11 h-11 rounded-lg flex items-center justify-center bg-sky-400 text-zinc-950 shrink-0 bg:hover-sky-500 hover:bg-sky-500 transition-colors">
            <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
